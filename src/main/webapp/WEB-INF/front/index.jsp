...
<div id="header" class="wrap">
	...
	<div class="navbar">
		...
		<div class="searchBook">
			<form method="post" action="productList.do">
				查找书籍：<input  type="text" class="text" size="14"name="key" placeholder="请输入商品关键字"  />
	...
	<div style="float: right">
			<form method="post" action="productList.do">
				最低价格：<input  type="text" class="text" name="lowerprice" placeholder="请输入价格"  />
				 最高价格：<input  type="text" class="text" name="highprice" placeholder="请输入价格"  />
				<input class="btn btn-info" type="submit" name="submit" value="搜索" />
			</form>
		 <!-- 	<form method="post" action="productList.do">
				最高价格：<input  type="text" class="text" name="highprice" placeholder="请输入价格"  /> 
	...
	<!-- <div class="highprice">
			<form method="post" action="productList.do">
				最高价格：<input  type="text" class="text" name="highprice" placeholder="请输入价格"  /> <input class="btn btn-info" type="submit" name="submit" value="搜索" />
			</form>
	</div> -->
</div>

...
public class BookController {
	...
	public String productList(Integer pageNum,Model model,String lowerprice,String highprice,String type,String key,HttpServletRequest request,HttpSession session){
		Set<String> bts=bookService.bookType();
		...
		if(lowerprice!=null&&highprice!=null){
			example.clear();
			Criteria cri = example.createCriteria();
			cri.andPirceBetween(lowerprice, highprice);
		}
		/*if(lowerprice!=null){
			example.clear();
			Criteria cri = example.createCriteria();
			cri.andPirceGreaterThan(lowerprice);
		}
		if(highprice!=null){
			example.clear();
			Criteria cri = example.createCriteria();
			cri.andPirceLessThanOrEqualTo(highprice);
		}*/
